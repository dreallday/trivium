defmodule TriviumWeb.ApiControllerTest do
  ...
  #   {:ok, dashboard} = Private.create_dashboard(@create_attrs)
  #   dashboard
  # end

  describe "test" do
    test "test function", %{conn: conn} do
      conn = get(conn, Routes.api_path(conn, :test))
      assert html_response(conn, 200) =~ "Test Call"
    end
  end
