defmodule TriviumWeb.PlanControllerTest do
  use TriviumWeb.ConnCase

  alias Trivium.Billing

  @create_attrs %{name: "some name", price: 42, price_per_call: 42, user_limit: 42}
  ...
  def fixture(:plan) do
    {:ok, plan} = Billing.create_plan(@create_attrs)
    plan
  end
